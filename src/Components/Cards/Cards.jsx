...
export default function Cards() {
  ...
  return (
    <div className='w-full grid grid-cols-4 gap-5 '>
      ...
      <div key={index} className='border-1 border-gray-400 rounded-2xl shadow-sm shadow-gray-400 cursor-pointer transition-all duration-300 ease-in-out hover:scale-95'>
         <div key={product.id}>
